...
if(isset($_POST['submit'])){
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO `crudd`(`first_name`, `last_name`, `email`, `gender`, `year`, `section`) 
...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color:rgb(55, 57, 59);">
